...
@section('pages')
    ...
    <div class="w-full max-w-4xl mx-auto px-4">
        <!-- Title -->
        <h2 class="text-center font-semibold my-9 text-base md:text-lg lg:text-xl">Sampaikan Laporan Anda melalui pilihan
            kanal berikut ini</h2>

        <!-- Cards Container -->
        <div
            class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 justify-items-center items-stretch mb-8 md:mb-12 max-w-5xl mx-auto">
            <!-- Card 1: Tatap Muka -->
            <a href="{{ route('detail') }}" class="w-full">
                <div
                    ...
                    <div class="relative flex items-center w-full py-3">
                        ...
                        <div class="flex-1 ml-1 sm:ml-1 md:ml-2 lg:ml-3">
                            <h3 class="font-semibold text-xs md:text-sm lg:text-base">Tatap Muka (Registrasi Online)</h3>
                            <p class="font-normal text-[10px] md:text-xs lg:text-sm">
                                Sampaikan langsung di Kantor Sekretariat Wakil Presiden Jln. Kebon Sirih No. 14, Jakarta
                                Pusat
                            </p>
                        </div>
                    </div>
            ...
            <a href="https://wa.me/6281117042204/?text=Halo" target="_blank" class="w-full">
                <div
                    ...
                    <div class="relative flex items-center w-full py-3">
                        ...
                        <div class="flex-1 ml-1 sm:ml-1 md:ml-2 lg:ml-3">
                            <h3 class="font-semibold text-xs md:text-sm lg:text-base">WhatsApp</h3>
                            <p class="font-normal text-[10px] md:text-xs lg:text-sm">
            ...
            <ol class="list-decimal list-outside space-y-2 ml-4">
                <li class="pl-1">
                    <p class=" hyphens-auto"
                        style="-webkit-hyphens: auto; -ms-hyphens: auto; hyphens: auto; word-break: break-word; text-align-last: left;">
                        Untuk melakukan Pengaduan Tatap Muka, Anda harus terlebih dahulu melakukan Registrasi Online melalui
                        <a href="{{ url('/') }}"
                            class="text-blue-600 hover:text-blue-800 underline">lapormaswapres.id</a>. Cek Alur Pengaduan
                        Tatap Muka <a href="{{ route('detail') }}"
                            class="text-blue-600 hover:text-blue-800 underline">disini</a>.
                    </p>
                </li>
                <li class="pl-1">
                    <p class=" hyphens-auto"
                        style="-webkit-hyphens: auto; -ms-hyphens: auto; hyphens: auto; word-break: break-word; text-align-last: left;">
                        Jika Anda tidak memiliki akses internet, Anda dapat datang langsung ke kantor Sekretariat Wakil
                        Presiden untuk melakukan Registrasi Online dengan bantuan petugas.
                    </p>
                </li>
            </ol>
        </div>
