...
@section('pages')
    ...
    <div class="w-full max-w-4xl mx-auto px-4">
        ...
        <div class="text-center my-9 ">
            ...
            <!-- Description -->
            <p class="text-center text-gray-600 opacity-85 italic mb-8">Panduan Langkah Demi Langkah Untuk Pengaduan Tatap
                Muka</p>
        </div>
        ...
        <div
            ...
            <!-- Card 1 -->
            <div
                class="relative flex items-center border-2 border-black rounded-2xl p-3 md:p-4 shadow-md w-full bg-[#9A7B7B] h-auto">
                <span
                    class="absolute top-0 left-0 mt-1 ml-1 h-full w-full rounded-2xl bg-[#f5f5f5] border border-black"></span>
                <div class="relative flex items-center w-full">
                    <div
                        class="w-8 h-8 md:w-11 md:h-11 lg:w-12 lg:h-12 mr-3 md:mr-4 flex-shrink-0 ml-4 bg-[#493A3A] text-white flex items-center justify-center rounded-md">
                        1</div>
                    <div class="flex-1 ml-1 sm:ml-2 md:ml-3 lg:ml-4">
                        ...
                        <p class="font-normal text-xs md:text-sm lg:text-sm">
                            Pelapor melakukan registrasi <i>online</i> melalui website <i>lapormaswapres.id</i> sebelum
                            datang ke lokasi.
                        </p>
                    </div>
                </div>
            ...
            <div
                ...
                <div class="relative flex items-center w-full">
                    ...
                    <div class="flex-1 ml-1 sm:ml-2 md:ml-3 lg:ml-4">
                        ...
                        <p class="font-normal text-xs md:text-sm lg:text-sm">
                            Pelapor datang ke lokasi pengaduan di Kantor Sekretariat Wakil Presiden yang beralamat di Jln.
                            Kebon Sirih No. 14, Jakarta Pusat.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div
                ...
                <div class="relative flex items-center w-full">
                    <div
                        ...
                        3</div>
                    <div class="flex-1 ml-1 sm:ml-2 md:ml-3 lg:ml-4">
                        <h3 class="font-semibold text-sm md:text-base lg:text-base">Pengecekan Bukti Registrasi
                            <i>Online</i></h3>
                        <p class="font-normal text-xs md:text-sm lg:text-sm">
            ...
            <div
                ...
                <div class="relative flex items-center w-full">
                    ...
                    <div class="flex-1 ml-1 sm:ml-2 md:ml-3 lg:ml-4">
                        ...
                        <p class="font-normal text-xs md:text-sm lg:text-sm">
                            Pelapor meninggalkan ruang pengaduan dan mengambil kembali kartu identitas dengan menukarkan
                            kartu ID Tamu.
                        </p>
                    </div>
                </div>
